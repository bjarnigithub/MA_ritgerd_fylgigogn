...
#./runallNeural.sh faer_villugr_adaltengingar.gz y n n n n split faer dev_faer_villugr_adaltengingar.txt outputpsdfile.psd faer_dev_inputfile.txt

##isl_villugr_threewords
#echo "fær - splitta setningum - aðaltengingar + þrjú orð sitthvoru megin við aðaltengingarnar"
#./runallNeural.sh faer_villugr_threewords.gz y y n n n split faer dev_faer_villugr_threewords.txt outputpsdfile.psd faer_dev_inputfile.txt

##isl_villugr_ordflokkar
#echo "fær - splitta setningum - aðaltengingar + orðflokkar"
#./runallNeural.sh faer_villugr_ordflokkar.gz y n y n n split faer dev_faer_villugr_ordflokkar.txt outputpsdfile.psd faer_dev_inputfile.txt

##isl_villugr_obeygjanlegt
#echo "fær - splitta setningum - aðaltengingar + athuga hvort orð sé óbeygjanlegt" 
#./runallNeural.sh faer_villugr_obeygjanlegt.gz y n n y n split faer dev_faer_villugr_obeygjanlegt.txt outputpsdfile.psd faer_dev_inputfile.txt

##isl_villugr_greinarmerki
#echo "fær - splitta setningum - aðaltengingar + skoða fleiri greinarmerki"
#./runallNeural.sh faer_villugr_greinarmerki.gz y n n n y split faer dev_faer_villugr_greinarmerki.txt outputpsdfile.psd faer_dev_inputfile.txt

#isl_villugr_allaruppf
echo "fær - splitta setningum - allar uppfærslur"
./runallNeural.sh faer_villugr_allaruppf.gz y y y y y split faer dev_faer_villugr_allaruppf.txt outputpsdfile.psd faer_dev_inputfile.txt
