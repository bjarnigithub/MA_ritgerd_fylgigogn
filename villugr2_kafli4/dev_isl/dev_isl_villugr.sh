...
./runallNeural.sh isl_villugr_adaltengingar.gz y n n n n split isl dev_isl_villugr_adaltengingar.txt outputpsdfile.psd dev_inputfile_fyrirallarvillugreiningar.txt

#isl_villugr_threewords
echo "ísl - splitta setningum - aðaltengingar + þrjú orð sitthvoru megin við aðaltengingarnar"
./runallNeural.sh isl_villugr_threewords.gz y y n n n split isl dev_isl_villugr_threewords.txt outputpsdfile.psd dev_inputfile_fyrirallarvillugreiningar.txt

#isl_villugr_ordflokkar
echo "ísl - splitta setningum - aðaltengingar + orðflokkar"
./runallNeural.sh isl_villugr_ordflokkar.gz y n y n n split isl dev_isl_villugr_ordflokkar.txt outputpsdfile.psd dev_inputfile_fyrirallarvillugreiningar.txt

#isl_villugr_obeygjanlegt
echo "ísl - splitta setningum - aðaltengingar + athuga hvort orð sé óbeygjanlegt" 
./runallNeural.sh isl_villugr_obeygjanlegt.gz y n n y n split isl dev_isl_villugr_obeygjanlegt.txt outputpsdfile.psd dev_inputfile_fyrirallarvillugreiningar.txt

#isl_villugr_greinarmerki
echo "ísl - splitta setningum - aðaltengingar + skoða fleiri greinarmerki"
./runallNeural.sh isl_villugr_greinarmerki.gz y n n n y split isl dev_isl_villugr_greinarmerki.txt outputpsdfile.psd dev_inputfile_fyrirallarvillugreiningar.txt

#isl_villugr_allaruppf
echo "ísl - splitta setningum - allar uppfærslur"
./runallNeural.sh isl_villugr_allaruppf.gz y y y y y split isl dev_isl_villugr_allaruppf.txt outputpsdfile.psd dev_inputfile_fyrirallarvillugreiningar.txt
